    ...
    return (
        <div className="w-full carousel">
            <div id="slide1" className="relative w-full h-[600px] carousel-item">
                ...
                <div className="absolute flex items-center rounded-lg h-full bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
            ...
            <div id="slide2" className="relative w-full h-[600px] carousel-item">
            ...
            <div id="slide3" className="relative w-full h-[600px] carousel-item">
            ...
            <div id="slide4" className="relative w-full h-[600px] carousel-item">
